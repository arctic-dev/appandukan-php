...
class SuperadmindashboardController extends BaseController {
	...
	*/
	...
	public function getIndex()
	{
		...
		return View::make('superadmin.dashboard.dashboard');
	}
...
public static function getFranchise($admin)
{
	...
	foreach ($senddata as $franchise) {
		if($franchise->parentIdPk==$admin)
		{
			echo '<option value="'.$franchise->userIdPk.'">'.$franchise->userId.'</option>';
		}
	}
...
public static function getAdminprod($admin)
{
	$userdata=Sample::category($admin);
	//$userdata=json_decode($senddata);
	//print_r($userdata);exit;
