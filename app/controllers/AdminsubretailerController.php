...
class AdminsubretailerController extends BaseController {
	...
	*/
	...
	public function getIndex()
	{
		...
		if($userdata && $userdata->status=="success")
		{
			...
			return View::make('admin.subretailer.selectview')->with('senddata',$senddata);
	...
	return View::make('admin.subretailer.manageview')->with('senddata',$senddata);
	...
	public function postSubr()
	{
		...
		return Redirect::to('admin/subretailer/manageview');
		
	}
	
	public function getDashboard()
	{
		return View::make('admin.subretailer.dashboard');
	}
	public function getAdd()
	{
		...
		return View::make('admin.subretailer.addview')->with('senddata',$senddata)->with('category',$category)->with('products',$products);
	}
	...
	public function getShow($id)
	{
		...
		return View::make('admin.subretailer.editview')->with('userdata',$userdata)->with('usercategory',$usercategory)->with('userproduct',$userproduct)->with('admincategory',$admincategory)->with('adminproduct',$adminproduct);
	}
	else
	{
	return Redirect::to('admin/noservice');
