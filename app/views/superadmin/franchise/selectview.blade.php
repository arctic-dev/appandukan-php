...
<div id="page-content">
  <div id='wrap'>
    ...
    <div class="container">
      <div class="row">
        {{ Form::open(array('url'=>'superadmin/franchise/fran', 'method'=>'post','class'=>'form-horizontal')) }}
          <div class="col-md-12">
               ...
               <div class="panel-heading">
                ...
                <div class="panel-body">
                 <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Franchise For Admin</label>
                      <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                  <div class="btn-toolbar">
                    ...
                    <a href="{{url('superadmin/dashboard')}}" class="btn-default btn">Cancel</a>
                  </div>
				  </form>
                </div>
              </div>
