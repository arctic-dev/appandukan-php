...
<div id="page-content">
  <div id='wrap'>
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <form action="<?php echo url();?>/superadmin/franchise/create" method="post" id="wizard" class="form-horizontal">
   ...
   @endif
                      <label for="fieldname" class="col-md-3 control-label">Franchise is Added to Admin</label>
                      <div class="col-md-6">
                        <select class="form-control" name="parentIdPk" id="admin" required="required">
						<option value="">select admin</option>
                        <?php if($userdata){foreach ($userdata as $users) {if($users->userType=="AD"){?>
