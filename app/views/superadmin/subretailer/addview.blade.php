  ...
  <div id='wrap'>
    <div id="page-heading">
      <ol class="breadcrumb col-sm-6">
        ...
        <li><a href="#">Sub Retailer</a></li>
        <li>Create Sub Retailer</li>
      </ol>
      <h1>&nbsp;</h1>
      <div class="options">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                <h4>Create Sub Retailer</h4>
              </div>
              <div class="panel-body">
              
                <form action="<?php echo url();?>/superadmin/subretailer/create" method="post" id="wizard" class="form-horizontal">
   ...
   @endif
                    <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Sub Retailer is Added Under Admin</label>
                      <div class="col-md-6">
                        <select class="form-control" id="admin" name="" required="required">
                       ...
                       <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Sub Retailer is Added Under to Franchise</label>
                      <div class="col-md-6">
                        <select class="form-control" id="franchise" name="" required="required">
                           <option value="">Select Franchise</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Sub Retailer is Added Under to Retailer</label>
                      <div class="col-md-6">
                        <select class="form-control" id="retailer" name="parentIdPk" required="required">
			...
			@endif
                     ...
                     <input type="hidden" name="userType" value="SR">
