...
<div id="page-content">
  <div id='wrap'>
    ...
    <div class="container">
      <div class="row">
        {{ Form::open(array('url'=>'superadmin/retailer/ret', 'method'=>'post','class'=>'form-horizontal')) }}
          <div class="col-md-12">
               ...
               <div class="panel-heading">
                ...
                <div class="panel-body">
                 <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Admin For Retailer</label>
                      <div class="col-md-6">
                 ...
                 <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Franchise For Retailer</label>
                      <div class="col-md-6">
                        <select class="form-control" name="userId" id="franchise">
                           </select>
                      </div>
                    </div>
