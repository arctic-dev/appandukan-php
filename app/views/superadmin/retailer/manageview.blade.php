          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body collapse in">
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                ...
                <tbody>
				<?php $i=1; if($senddata){ foreach ($senddata as $retailerdata){if($retailerdata->userType=="RT"){?>
                  <tr class="odd gradeX">
                    <td>{{$i}}</td>
                    ...
                    <td class="center"><a href="{{url('superadmin/retailer/show/'.$retailerdata->userIdPk)}}"><i class="fa fa-edit"></i></a> <a href="#" style="margin-left:10px;"><i class="fa fa-trash-o"></i> </a></td>
                  </tr>
				  <?php $i++;}}}?>
