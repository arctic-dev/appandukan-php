  ...
  <div id='wrap'>
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <form action="<?php echo url();?>/superadmin/retailer/create" method="post" id="wizard" class="form-horizontal">
   ...
   @endif
                    <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Retailer is Added Under Admin</label>
                      <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <select class="form-control" id="franchise" name="parentIdPk" required="required">
