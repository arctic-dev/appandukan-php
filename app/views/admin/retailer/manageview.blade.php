                ...
                <tbody>
                 <?php $i=1; if($senddata){ foreach ($senddata as $retailerdata){if($retailerdata->userType=="RT"){?>
                  ...
                  <tr class="odd gradeX">
                    ...
                    <td class="center"><a href="{{url('admin/retailer/show/'.$retailerdata->userIdPk)}}"><i class="fa fa-edit"></i></a> <a href="#" style="margin-left:10px;"><i class="fa fa-trash-o"></i> </a></td>
                  </tr>
                  <?php $i++;}}} ?></tr>
                  </tbody>
              </table>
