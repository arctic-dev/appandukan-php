...
//print_r($data); exit;                    ?>
                    <tr>
                            <td>{{$data->icc_tran_id}}</td>
                            <td>{{$data->icc_usercardno}}</td>
                            <td>{{$data->icc_username}}</td>
                            <td>{{$data->icc_userlname}}</td>
                            <td>{{$data->icc_usermobile}}</td>
                            <td>{{$data->icc_userstate}}</td>
                            <td>{{$data->icc_usercity}}</td>
                            <td>{{$data->icc_userpincode}}</td>
