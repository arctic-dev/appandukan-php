          ...
          <div class="panel panel-primary">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <form action="<?php echo url();?>/admin/franchise/create" method="post" id="wizard" class="form-horizontal">
                  <fieldset title="Step 1">
                  <input type="hidden" name="userType" value="FR">
