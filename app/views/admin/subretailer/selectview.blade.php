...
<div id="page-content">
  <div id='wrap'>
    ...
    <div class="container">
      <div class="row">
        {{ Form::open(array('url'=>'admin/subretailer/subr', 'method'=>'post','class'=>'form-horizontal')) }}
          <div class="col-md-12">
            <div class="panel panel-primary"> 
              ...
              <div class="col-md-6" >
               ...
               <div class="panel-heading">
                ...
                <div class="form-group">
                      <label for="fieldname" class="col-md-3 control-label">Retailer For sub-Retailer</label>
                      <div class="col-md-6">
                        <select class="form-control" name="userId" id="retailer" required="required">
                           </select>
                      </div>
                      <div id="retailernofound"></div>
                    </div>
