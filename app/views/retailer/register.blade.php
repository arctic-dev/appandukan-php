	...
	<div id="wrap">
		<div id="page-heading">
			<ol class="breadcrumb">
				...
				<li>Register</li>
				<li class="active">New Sub Retailer</li>
			</ol>

			<h1>New Sub Retailer</h1>
			<div class="options">
				...
				<div class="col-sm-12">
				  <div class="panel panel-primary">
				      <div class="panel-heading">
				          <h4>Register New Sub Retailer</h4>
				          
				      </div>
				      <div class="panel-body">
				      	<form class="form-horizontal"  name="myForm" method="post" action="<?php echo url();?>/Retailer/create"  >
