      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-primary">
            ...
            <?php } ?>
            <div class="col-md-12">
             {{ Form::open(array('url'=>'retailer/icash/loginotp','method'=>'get', 'class'=>'form-horizontal')) }}
              <div class="panel-heading">
                <h4>IMPS Waalet Form</h4>
              </div>
              <div class="panel-body">
                <div class="form-group">
                          <label for="fieldurl" class="col-md-3 control-label">Enter Your Otp To Validate Login</label>
                          <div class="col-md-6">
                  ...
                  <a href="{{url('retailer/icash/loginotpgenerate/'.$mobilenumber)}}" class="btn-default btn">Resend OTP</button>     
              </div>
              <div class="row" >
                      <div class="col-md-12">
