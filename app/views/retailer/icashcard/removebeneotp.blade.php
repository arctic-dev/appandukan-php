      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-primary">
            ...
            <?php } ?>
            <div class="col-md-12">
             {{ Form::open(array('url'=>'retailer/icash/removebeneotp','method'=>'get', 'class'=>'form-horizontal')) }}
              ...
              <div class="panel-body">
                <div class="form-group">
						...
						<input type="hidden" name="benid" value="{{$id}}">



                  <!--a href="{{url('retailer/icash/removeotpresend/'.$id)}}" class="btn-default btn">Resend OTP</a-->     
              </div>
              <div class="row" >
                      <div class="col-md-12">
