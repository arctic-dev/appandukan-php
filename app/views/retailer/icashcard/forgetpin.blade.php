      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-primary">
            ...
            <?php } ?>
            <div class="col-md-12">
             {{ Form::open(array('url'=>'retailer/icash/forgetpinvalidate','method'=>'get', 'class'=>'form-horizontal')) }}
              <div class="panel-heading">
                <h4>IMPS Waalet Form</h4>
              </div>
              <div class="panel-body">
                <div class="form-group">
                          <label for="fieldurl" class="col-md-3 control-label">Enter Your Registered Mobile Number</label>
                          <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                              <div class="btn-toolbar">
                                ...
                                <a href="{{url('retailer/icash/login')}}" class="btn-default btn">Cancel</a>
                              </div>
                            </div>
                          </div>
                        </div>
