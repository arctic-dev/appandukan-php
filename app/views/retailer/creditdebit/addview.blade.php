    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          {{ Form::open(array('url'=>'retailer/creditdebit/create','method'=>'post', 'class'=>'form-horizontal')) }}
             ...
             <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <select class="form-control" name="userIdPk" id="userIdPk">
							<option value="">select  sub retailer</option>
                        
						   <?php if($senddata){foreach ($senddata as $users) {if($users->userType=="SR"){?>
                          <option value="{{$users->userIdPk}}">{{$users->userId}}</option>
                        <?php }}}?> 
                        
						</select>
						<div id="userIdPkerror"></div>
                      </div>
