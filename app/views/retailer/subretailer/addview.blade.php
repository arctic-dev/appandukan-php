...
<div id="page-content">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <form action="<?php echo url();?>/retailer/subretailer/create" method="post" id="wizard" class="form-horizontal">
  ...
  <?php $catcode=Input::old('catgcode');
  foreach($category as $categories){?>
  <li class="parent-list"><input type="checkbox" name="catgcode[]" id="" <?php if($catcode!=""){foreach($catcode as $catg){
      if($catg==$categories->catgCode){
        echo "checked";
      }}} ?> class="canine parent" value="{{$categories->catgCode}}" />{{$categories->fullName}} <i class="fa fa-arrow-down"></i>
   <ul>
   <?php $prodcode=Input::old('prodCode'); 
   foreach($products as $product)
   {if($product->catgCode==$categories->catgCode){?>
    <li><input type="checkbox" name="prodCode[]" class="canine" <?php if($prodcode!=""){foreach($prodcode as $prod){
      if($prod==$product->prodCode){
        echo "checked";
      }}} ?> value="{{$product->prodCode}}"/> {{$product->fullName}}</li>
	<?php }}?>
    </ul>
  </li>
  <?php  }?> 
