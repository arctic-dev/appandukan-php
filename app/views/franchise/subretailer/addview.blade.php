          ...
          <div class="panel panel-primary">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <form action="<?php echo url();?>/franchise/subretailer/create" method="post" id="wizard" class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <select class="form-control" name="parentIdPk" id="retailer">
                            <?php if($senddata){foreach ($senddata as $users) {if($users->userType=="RT"){?>
