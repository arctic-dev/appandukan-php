              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                ...
                <tbody>
                  ...
                  <tr class="odd gradeX">
                    ...
                    <td class="center"><a href="{{url('franchise/subretailer/show/'.$subretailerdata->userIdPk)}}"><i class="fa fa-edit"></i></a> <a href="#" style="margin-left:10px;"><i class="fa fa-trash-o"></i> </a></td>
                  </tr>
                  <?php $i++;}}?></tr>
