    ...
    <div id='wrap'>
        ...
        <h1>&nbsp;</h1>
            <ol class="breadcrumb col-sm-6">
                <li class='active'><a href="<?php echo url('franchise/dashboard');?>">Dashboard</a></li>
            </ol>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <small>+X.X% from last period</small>
                                </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center"><span class="text-top"></span>XX.X<span class="text-smallcaps"></span></div>
                                    <small>-XX.X% from last week</small>
                                </div>
