                  ...
                  <div class="row">
                    <div class="panel-group" id="accordion">
                      ...
                      <div class="panel panel-default">
						...
						{
						$output[]=valueunique($busdetail,'BUSTYPE',$busdata['BUSTYPE']);
...
?>
                        <div id="collapseTwo" class="panel-collapse collapse">
						  ...
						  <?php for($i=0;$i<count($output);$i++){if($output[$i]!='BUSTYPE')
							  {?>
                            <div class="checkbox">
                              <label>
							  
							  
                                <input type="checkbox" val="{{$output[$i]}}" class="clsTravelsType" onchange="doFilter();">
                                {{$output[$i]}}</label>
                            </div>
							<?php }}?>
...
$.ajax({
     ...
     url: '<?php echo url();?>/subretailer/bus/seatlayout',
     async: false,
     type : 'GET',
...
function ListAvailableTrips() {
    ...
    if (jsonBus[0].ROUTEID) {
        ...
        List += "<div class='row'>";
		List+="<form method='get' action='http://localhost/laravel-appendukan/subretailer/bus/book'>";
		...
		List+="<input type='hidden' name='seats' id='totalseat_"+this.ROUTEID+"' value=''>";
		List+="<input type='hidden' name='amount' id='totalamount_"+this.ROUTEID+"' value=''>";
        List += "<select id='ddlBoarding" + this.ROUTEID + "' class='form-control'>";
        List += "<option value='0'>Select Boarding</option>";
                              ...
                              <div class="row">
                                <div class="view_seats_1" id="view_seats_{{$busdata['ROUTEID']}}" style="overflow: hidden; display: block;">
                                  ...
                                  <div class="modal-footer">
                                    <div class="row">
									<form method="get" action="<?php echo url();?>/subretailer/bus/book">
