                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group" >
                                <input type="text" class="input-small form-control" name="start" placeholder="Place of Arrivel"/>
                                <span class="input-group-addon">To</span>
                                <input type="text" class="input-small form-control" name="end" placeholder="Place of Depature"/>
                            </div>
                        </div>
                    </div>
                  
                   <div class="form-group">
                <label class="col-sm-3 control-label">Depart</label>
                <div class="col-sm-8">
                    <div class="input-daterange input-group" id="datepicker3">
                        <input type="text" class="input-small form-control form" name="start" placeholder="Date of Arrivel"/>
                        <span class="input-group-addon">Return</span>
                        <input type="text" class="input-small form-control to" name="end" placeholder="Date of Depature"/>
                    </div>
                </div>
            </div>
