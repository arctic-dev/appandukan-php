  ...
  <div id='wrap'>
    <div id="page-heading">
      <ol class="breadcrumb col-sm-6">
        <li><a href="<?php echo url('subretailer/dashboard');?>">Subretailer</a></li>
        <li>Profile</li>
        <li>Edit Profile</li>
      </ol>
      <h1>&nbsp;</h1>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-12">
            <div class="panel panel-primary"> {{ Form::open(array('url'=>'subretailer/dashboard/store', 'method'=>'post','class'=>'form-horizontal')) }}
