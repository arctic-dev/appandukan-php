    ...
    <div id="wrap">
          ...
          <div class="col-sm-12">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form class="form-horizontal" method="post" action="<?php echo url();?>/subretailer/dashboard/drecharge">
      ...
      @endif
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="disabledinput" placeholder="Service Provider CA No." name="number">
                    </div>
                    <div class="col-sm-3">
