...
<header class="navbar navbar-inverse <?php if (isset($_COOKIE["fixed-header"])) {echo 'navbar-static-top';} else {echo 'navbar-fixed-top';} ?>" role="banner"> <a id="leftmenu-trigger" class="tooltips" data-toggle="tooltip" data-placement="right" title="Toggle Sidebar"></a> 
  ...
  <div id="page-container">
        ...
        <ul class="acc-menu">
          <li><a href="<?php echo url('admin/static/about');?>"><span>About us</span></a></li>
          <li><a href="<?php echo url('admin/static/terms');?>"><span>Terms and Conditions</span></a></li>
          <li><a href="<?php echo url('admin/static/howitworks');?>"><span>How it Works</span></a></li>
        </ul>
      </li>
