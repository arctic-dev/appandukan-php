...
<head>
	<meta charset="utf-8">
	<title>Appan Dukan Super Admin</title>
...
} elseif ($pageName == "superadmin/dashboard"||$pageName == "superadmin/admin/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/franchise/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "superadmin/retailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/subretailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}") {
    scripttag('plugins/form-daterangepicker/daterangepicker-bs3.css'); //<!-- DateRangePicker -->
...
} elseif ($pageName == "superadmin/admin"||$pageName == "superadmin/franchise" ||$pageName == "superadmin/retailer"|| $pageName == "superadmin/subretailer"||  $pageName == "superadmin/creditdebit" ||$pageName == "manager_users.php") {
...
<body class="<?php if (isset($_COOKIE["admin_leftbar_collapse"])) echo ($_COOKIE['admin_leftbar_collapse'] . " "); // check collapse state with php
    ...
    <header class="navbar navbar-inverse <?php if (isset($_COOKIE["fixed-header"])) {echo 'navbar-static-top';} else {echo 'navbar-fixed-top';} ?>" role="banner">
        ...
        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="<?php echo url('superadmin/dashboard');?>"></a>
        </div>
        		...
        		<ul class="dropdown-menu userinfo arrow">
        			...
        			<li class="userlinks">
        				<ul class="dropdown-menu">
        					<li><a href="<?php echo url();?>/superadmin/profile">Edit Profile <i class="pull-right fa fa-pencil"></i></a></li>
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li style="margin-top:30px;"><a href="<?php echo url('superadmin/dashboard');?>"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                <li><a href="<?php echo url('superadmin/sitesettings');?>"><i class="fa fa-home"></i> <span>Site Settings</span></a></li>
                
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Admin</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('superadmin/admin/add');?>"><span>Create Admin</span></a></li>
                        <li><a href="<?php echo url('superadmin/admin');?>"><span>Manage Admin</span></a></li>                     
                        <li><a href="<?php echo url('superadmin/admin/dashboard');?>"><span>Admin Overview</span></a></li>                     
                    </ul>
                </li>
                
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Franchise</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('superadmin/franchise/add');?>"><span>Create Franchise</span></a></li>
                        <li><a href="<?php echo url('superadmin/franchise');?>"><span>Manage Franchise</span></a></li> 
                        <li><a href="<?php echo url('superadmin/franchise/dashboard');?>"><span>Franchise Overview</span></a></li>                                         
                    </ul>
                </li>
                
                 <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Retailer</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('superadmin/retailer/add');?>"><span>Create Retailer</span></a></li>
                        <li><a href="<?php echo url('superadmin/retailer/');?>"><span>Manage Retailer</span></a></li>
                        <li><a href="<?php echo url('superadmin/retailer/dashboard');?>"><span>Franchise Overview</span></a></li>                                                              
                    </ul>
                </li>
                
                 <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Sub Retailer</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('superadmin/subretailer/add');?>"><span>Create Sub Retailer</span></a></li>
                        <li><a href="<?php echo url('superadmin/subretailer/');?>"><span>Manage Sub Retailer</span></a></li>  
                        <li><a href="<?php echo url('superadmin/subretailer/dashboard');?>"><span>Sub Retailer Overview</span></a></li>                                                                                 
                    </ul>
                </li>
                
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Credit / Debit</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('superadmin/creditdebit/add');?>"><span>Add Credit / Debit</span></a></li>
                        <li><a href="<?php echo url('superadmin/creditdebit/');?>"><span>Manage Credit / Debit</span></a></li>  
                        <li><a href="<?php echo url('superadmin/creditdebit/dashboard');?>"><span>Credit / Debit Overview</span></a></li>                                                                                 
                    </ul>
                </li>
...
} elseif ($pageName == "superadmin/dashboard"||$pageName == "superadmin/admin/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/franchise/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "superadmin/retailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/subretailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/creditdebit/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}") {
...
} elseif ($pageName == "superadmin/admin/add/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/franchise/add/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "superadmin/retailer/add/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "superadmin/subretailer/add/{one?}/{two?}/{three?}/{four?}/{five?}") {
...
} elseif ($pageName == "superadmin/admin/show/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "superadmin/franchise/show/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "superadmin/retailer/show/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "superadmin/subretailer/show/{one?}/{two?}/{three?}/{four?}/{five?}") {
    scripttag("plugins/form-validation/jquery.validate.min.js");
    scripttag("plugins/form-stepy/jquery.stepy.js");
...
$(document).ready(function()
{
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/mailcheck/'+email,
     async: false,
     type : 'GET',
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/mobilecheck/'+mobile,
     async: false,
     type : 'GET',
...
$('#fielduserid').change(function()
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/usercheck/'+user,
     async: false,
     type : 'GET',
...
$('#parentId').val(adminname);
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/franchise/'+admin,
     async: false,
     type : 'GET',
 ...
 $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/adminprod/'+adminname,
     async: false,
     type : 'GET',
...
$('#parentId').val(adminname);
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/retailer/'+franchise,
     async: false,
     type : 'GET',
 ...
 $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/franchiseprod/'+adminname,
     async: false,
     type : 'GET',
...
$('#parentId').val(adminname);
 $.ajax({
     ...
     url: '<?php echo url();?>/superadmin/dashboard/retailerprod/'+adminname,
     async: false,
     type : 'GET',
