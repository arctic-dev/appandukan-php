...
<head>
    <meta charset="utf-8">
    <title>Appan Dukan Franchise</title>
...
} elseif ($pageName == "franchise/dashboard"||$pageName == "franchise/retailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "franchise/subretailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}") {
    scripttag('plugins/form-daterangepicker/daterangepicker-bs3.css'); //<!-- DateRangePicker -->
...
} elseif ($pageName == "franchise/retailer"|| $pageName == "franchise/subretailer/manageview/{one?}/{two?}/{three?}/{four?}/{five?}"||  $pageName == "franchise/creditdebit" ||$pageName == "manager_users.php") {
...
<body class="<?php if (isset($_COOKIE["admin_leftbar_collapse"])) echo ($_COOKIE['admin_leftbar_collapse'] . " "); // check collapse state with php
    ...
    <header class="navbar navbar-inverse <?php if (isset($_COOKIE["fixed-header"])) {echo 'navbar-static-top';} else {echo 'navbar-fixed-top';} ?>" role="banner">
        ...
        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="<?php echo url('franchise/dashboard');?>"></a>
        </div>
                ...
                <ul class="dropdown-menu userinfo arrow">
                    ...
                    <li class="userlinks">
                        <ul class="dropdown-menu">
                            <li><a href="{{url('franchise/profile')}}">Edit Profile <i class="pull-right fa fa-pencil"></i></a></li>
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li style="margin-top:30px;"><a href="<?php echo url('franchise/dashboard');?>"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                
                
                
                 <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Retailer</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('franchise/retailer/add');?>"><span>Create Retailer</span></a></li>
                        <li><a href="<?php echo url('franchise/retailer/');?>"><span>Manage Retailer</span></a></li>
                        <li><a href="<?php echo url('franchise/retailer/dashboard');?>"><span>Franchise Overview</span></a></li>                                                              
                    </ul>
                </li>
                
                 <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Sub Retailer</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('franchise/subretailer/add');?>"><span>Create Sub Retailer</span></a></li>
                        <li><a href="<?php echo url('franchise/subretailer/');?>"><span>Manage Sub Retailer</span></a></li>  
                        <li><a href="<?php echo url('franchise/subretailer/dashboard');?>"><span>Sub Retailer Overview</span></a></li>                                                                                 
                    </ul>
                </li>
                
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Credit / Debit</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('franchise/creditdebit/add');?>"><span>Add Credit / Debit</span></a></li>
                        <li><a href="<?php echo url('franchise/creditdebit/');?>"><span>Manage Credit / Debit</span></a></li>  
                        <li><a href="<?php echo url('franchise/creditdebit/dashboard');?>"><span>Credit / Debit Overview</span></a></li>                                                                                 
                    </ul>
                </li>
...
} elseif ($pageName == "franchise/dashboard"||$pageName == "franchise/retailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "franchise/subretailer/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName == "franchise/creditdebit/dashboard/{one?}/{two?}/{three?}/{four?}/{five?}") {
...
} elseif ($pageName == "franchise/retailer/add/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "franchise/subretailer/add/{one?}/{two?}/{three?}/{four?}/{five?}") {
...
$('#parentId').val(adminname);
 $.ajax({
	...
	if($('#userIdPk').val()=="")
	{
	$('#userIdPkerror').text('please select a Retailer');
	}
	else{
    $('#userIdPkerror').text('');
