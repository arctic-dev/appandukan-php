...
<head>
    <meta charset="utf-8">
    <title>Appan Dukan Sub Retailer</title>
...
} elseif ($pageName == "subretailer/bus") {   
...
} elseif ($pageName == "subretailer/dashboard") {
    linktag('plugins/form-daterangepicker/daterangepicker-bs3.css'); //<!-- DateRangePicker -->
...
} elseif ( $pageName == "subretailer/dashboard/mobilerechargepost/{one?}/{two?}/{three?}/{four?}/{five?}" ||$pageName == "subretailer/dashboard/mobilerechargepre/{one?}/{two?}/{three?}/{four?}/{five?}"||  $pageName == "subretailer/dthrechargemanage" ||$pageName == "manager_users.php") {
...
<script type='text/javascript' src='<?php echo url('assets/admin/') ?>/plugins/tree/jquery-checktree.js'></script> 
<script>
$('#tree').checktree();
</script>
</head>
...
<body class="<?php if (isset($_COOKIE["admin_leftbar_collapse"])) echo ($_COOKIE['admin_leftbar_collapse'] . " "); // check collapse state with php
    ...
    <header class="navbar navbar-inverse <?php if (isset($_COOKIE["fixed-header"])) {echo 'navbar-static-top';} else {echo 'navbar-fixed-top';} ?>" role="banner">
        ...
        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="<?php echo url('subretailer/dashboard');?>"></a>
        </div>
        ...
        <ul class="nav navbar-nav pull-right toolbar">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu userinfo arrow">
                    <li class="username">
                        <a href="#">
                            <div class="pull-right"><h5>HI,{{Session::get('user_name')}}</h5><small>Logged in as <span>{{Session::get('user_name')}}</span></small></div>
                        </a>
                    </li>
                    <li class="userlinks">
                        <ul class="dropdown-menu">
                            <li><a href="{{url('subretailer/dashboard/profile')}}">Edit Profile <i class="pull-right fa fa-pencil"></i></a></li>
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li style="margin-top:30px;"><a href="<?php echo url('subretailer/dashboard');?>"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                ...
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Mobile</span> </a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo url('subretailer/dashboard/mposrecharge');?>"><span>Postpaid </span></a></li>
                        <li><a href="<?php echo url('subretailer/dashboard/mprerecharge');?>"><span>Prepaid </span></a></li>
                        <li><a href="<?php echo url('subretailer/dashboard/mobilerechargepre');?>"><span>Prepaid History</span></a></li>
						<li><a href="<?php echo url('subretailer/dashboard/mobilerechargepost');?>"><span>Postpaid History</span></a></li>                     
                    </ul>
                </li>
                
                    <li><a href="javascript:;"><i class="fa fa-th"></i> <span>DTH</span> </a>
                        <ul class="acc-menu">
                            <li><a href="<?php echo url('subretailer/dashboard/dthrecharge');?>"><span>Recharge </span></a></li>
                            <li><a href="<?php echo url('subretailer/dashboard/dthrechargemanage');?>"><span>DTH Recharge History</span></a></li>
                        </ul>
                    </li>
          
                <!--li><a href="javascript:;"><i class="fa fa-th"></i> <span>PanCard</span> </a>
                        <ul class="acc-menu">
                            <li><a href="<?php echo url('subretailer/dashboard/pancard');?>"><span>Add Pan Card</span></a></li>
                            <li><a href="<?php echo url('subretailer/dashboard/pancardmanage');?>"><span>Manage Pan Cards</span></a></li>
                        </ul>
                    </li-->
                    <!--li><a href="javascript:;"><i class="fa fa-th"></i> <span>Bus Booking</span> </a>
                        <ul class="acc-menu">
                            <li><a href="<?php echo url('subretailer/bus');?>"><span>Bus Booking</span></a></li>
                            <li><a href="<?php echo url('subretailer/bus/manage');?>"><span>Manage Bus Booking</span></a></li>
                        </ul>
                    </li-->
                    <!--li><a href="javascript:;"><i class="fa fa-th"></i> <span>Flight Booking</span> </a>
                        <ul class="acc-menu">
                            <li><a href="<?php echo url('subretailer/flight');?>"><span>Flight Booking</span></a></li>
                            <li><a href="<?php echo url('subretailer/flight/manage');?>"><span>Manage Flight Booking</span></a></li>
                        </ul>
                    </li-->
          				<!--li><a href="javascript:;"><i class="fa fa-th"></i> <span>Hotel Booking</span> </a>
                        <ul class="acc-menu">
                            <li><a href="<?php echo url('subretailer/hotel');?>"><span>Hotel Booking</span></a></li>
                            <li><a href="<?php echo url('subretailer/Hotel/manage');?>"><span>Manage Hotel Booking</span></a></li>
                        </ul>
                    </li-->
...
} elseif ($pageName=="subretailer/dashboard/pancard/{one?}/{two?}/{three?}/{four?}/{five?}"||$pageName=="subretailer/bus") {
...
} elseif ($pageName == "subretailer/dashboard/12") {
    scripttag("plugins/form-daterangepicker/moment.min.js");
...
} elseif ($pageName == "subretailer/dashboard/mobilerechargepost/{one?}/{two?}/{three?}/{four?}/{five?}"  ||$pageName == "subretailer/dashboard/mobilerechargepre/{one?}/{two?}/{three?}/{four?}/{five?}"  || $pageName == "subretailer/dashboard/dthrechargemanage" ||$pageName == "manager_users.php" || $pageName="subretailer/dashboard/pancardmanage/{one?}/{two?}/{three?}/{four?}/{five?}") {
...
} elseif ($pageName == "subretailer/dashboard/dthrechargemanage"|| $pageName == "subretailer/dashboard/mobilerechargepost/{one?}/{two?}/{three?}/{four?}/{five?}"  ||$pageName == "subretailer/dashboard/mobilerechargepre/{one?}/{two?}/{three?}/{four?}/{five?}"   || $pageName == "manager_users.php"|| $pageName == "subretailer/dashboard/pancardmanage") {
    scripttag("demo/demo-datatables.js");
} elseif ($pageName == "form-fileupload.php") {
    // echo "// File Upload";
...
$(document).ready(function()
{
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/subretailer/dashboard/mailcheck/'+email,
     async: false,
     type : 'GET',
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/subretailer/dashboard/mobilecheck/'+mobile,
     async: false,
     type : 'GET',
...
$('#fielduserid').change(function()
   ...
   // alert(user);
    $.ajax({
     ...
     url: '<?php echo url();?>/subretailer/dashboard/usercheck/'+user,
     async: false,
     type : 'GET',
...
$('#source').change(function()
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/subretailer/bus/destination/'+user,
     async: false,
     type : 'GET',
...
$('#country').change(function()
    ...
    $.ajax({
     ...
     url: '<?php echo url();?>/subretailer/hotel/destinationcity/'+user,
     async: false,
     type : 'GET',
